...
function scrollFX(s) {
    ...
    if (document.documentElement.scrollHeight != l) {
        var t = window.pageYOffset || document.documentElement.scrollTop
          , o = lastScrollTop > t;
        lastScrollTop = t <= 0 ? 0 : t;
        document.querySelectorAll('[data-scroll-lock-distance], [class*="scroll-fx-up-"], [class*="scroll-fx-down-"], [class*="scroll-fx-left-"], [class*="scroll-fx-right-"], [class*="scroll-fx-in-fade"], [class*="scroll-fx-out-fade"], [class*="scroll-fx-zoom-"], [class*="scroll-fx-rotate-"], [class*="scroll-fx-reverse-rotate-"]').forEach((t=>{
            var c = window.pageYOffset
              ...
              , f = scrollPos - e;
            if (i) {
                var d = parseInt(i.getAttribute("data-scroll-lock-distance"))
                  , u = parseInt(i.getAttribute("data-scroll-lock-scroll-y"));
                document.body.classList.contains("scroll-fx-lock") && "scroll" == s.type && (u += f),
                u && (e = u)
            } else if (t.hasAttribute("data-scroll-lock-distance") && t.classList.contains("scroll-fx-lock-init")) {
                d = parseInt(t.getAttribute("data-scroll-lock-distance"));
                var x = parseInt(t.getAttribute("data-scroll-lock-scroll-y-start"))
                  , p = parseInt(t.getAttribute("data-scroll-lock-offset"))
                  , m = p
                  , b = parseInt(t.getAttribute("data-scroll-lock-scroll-y"));
                if (document.body.classList.contains("scroll-fx-lock")) {
                    "scroll" == s.type && (m += f,
                    b += f);
                    var h = x;
                    if (n) {
                        if (p > x || m < -d)
                            document.body.classList.remove("scroll-fx-lock"),
                            t.classList.remove("scroll-fx-lock-init"),
                            t.classList.add("bloc-temp-past-lock-point"),
                            document.getElementById("scrollFX-filler").remove(),
                            window.scrollTo({
                                top: h,
                                left: 0,
                                behavior: "instant"
                            ...
                            t.setAttribute("data-scroll-lock-offset", m),
                            e = b,
                            t.setAttribute("data-scroll-lock-scroll-y", b)
                    } else {
                        t.getBoundingClientRect().top;
                        if (p > x || m > d || !t.classList.contains("scroll-fx-bloc-past-exit-point") && !n && p > 0)
                            document.body.classList.remove("scroll-fx-lock"),
                            t.classList.remove("scroll-fx-lock-init"),
                            t.classList.add("bloc-temp-past-lock-point"),
                            document.getElementById("scrollFX-filler").remove(),
                            ...
                            t.classList.remove("scroll-fx-bloc-past-exit-point"),
                            t.setAttribute("data-scroll-lock-offset", 0);
                        else
                            t.setAttribute("data-scroll-lock-offset", m),
                            e = b,
                            t.setAttribute("data-scroll-lock-scroll-y", b)
            ...
            t.hasAttribute("data-scroll-fx-delay") && (e += parseInt(t.getAttribute("data-scroll-fx-delay")),
            t.matches('[class*="-in-fade"],[class*="-out-fade"]') && (t.style.opacity = "0.0"));
            var k = r.top + e;
            if (k < a) {
                !t.classList.contains("scroll-fx-in-range") && t.matches('[class*="scroll-fx-in-fade"], [class*="scroll-fx-out-fade"]') && t.classList.add("scroll-fx-in-range");
                var v = 10;
                t.hasAttribute("data-scroll-fx-resistance") && (v = parseInt(t.getAttribute("data-scroll-fx-resistance")));
                var g = l / 2 - t.offsetHeight / 2
                  , y = (t.offsetHeight,
                c - k + t.offsetHeight / 100 + g)
                  , L = e / (k - g)
                  , A = (k - g) / e
                  , w = y / v
                  , I = w + "%"
                  ...
                  , H = "in"
                  , X = 30;
                if (t.classList.contains("scroll-fx-continuous") && (X = 0),
                (w > 0 || !t.matches('[class*="-in"]')) && (t.classList.contains("scroll-fx-continuous") && t.matches('[class*="-out"]') || (I = 0,
                E = 0),
                w > 0 && (L = 1,
                A = 1),
                t.matches('[class*="-in-fade"],[class*="-out-fade"]') && (t.style.opacity = "1.0"),
                t.matches('[class*="-rotate-in"],[class*="-rotate-out"]') && (F = 0)),
                t.hasAttribute("data-scroll-lock-distance")) {
                    var z = t.classList.contains("scroll-fx-bloc-past-exit-point");
                    if (w > 1 && !z || z && w < 1.5) {
                        if (!document.body.classList.contains("scroll-fx-lock") && !t.classList.contains("bloc-temp-past-lock-point")) {
                            var B = t.offsetTop;
                            d = parseInt(t.getAttribute("data-scroll-lock-distance")),
                            parseInt(t.offsetHeight);
                            document.body.classList.add("scroll-fx-lock"),
                            t.classList.add("scroll-fx-lock-init"),
                            t.classList.contains("scroll-fx-bloc-past-exit-point") || (t.setAttribute("data-scroll-lock-scroll-y-start", B),
                            t.setAttribute("data-scroll-lock-scroll-y", e)),
                            t.setAttribute("data-scroll-lock-offset", 0);
                            var P = document.createElement("div");
                            P.id = "scrollFX-filler",
                            P.style.cssText = "height:" + d + "px;",
                            t.parentNode.insertBefore(P, t)
                        }
                    } else
                        (parseInt(w) > 2 || parseInt(w) < -2) && t.classList.remove("bloc-temp-past-lock-point")
                }
                w > X && t.matches('[class*="-out"]') && (H = "out",
                I = -Math.abs(w - X) + "%",
                E = Math.abs(w - X) + "%",
                F = Math.abs(w - X),
                T = 1 - y / (25 * v) + .8);
                var S = "";
                if (t.matches('[class*="scroll-fx-left-' + H + '"]') && (S = "translate3d(" + I + ",0,0)"),
                t.matches('[class*="scroll-fx-right-' + H + '"]') ? S = "translate3d(" + E + ",0,0)" : t.matches('[class*="scroll-fx-up-' + H + '"]') ? S = "translate3d(0," + E + ",0)" : t.matches('[class*="scroll-fx-down-' + H + '"]') && (S = "translate3d(0," + I + ",0)"),
                t.matches('[class*="scroll-fx-zoom-push"], [class*="scroll-fx-zoom-pull"]')) {
                    var Y = L;
                    if (t.matches('[class*="scroll-fx-zoom-push"]')) {
                        if ((Y = A) > 2)
                            Y = 2;
                        else {
                            var M = t.getAttribute("scroll-fx-last-scale");
                            o ? M > Y && (Y = M) : Y > M && (Y = M)
                        }
                        t.setAttribute("scroll-fx-last-scale", Y)
                    }
                    t.matches('[class*="scroll-fx-up-"], [class*="scroll-fx-down-"], [class*="scroll-fx-left-"], [class*="scroll-fx-right-"]') ? S += "scale(" + Y + ")" : S = "scale(" + Y + ")"
                }
                t.matches('[class*="scroll-fx-rotate-' + H + '"], [class*="scroll-fx-reverse-rotate-' + H + '"]') && (t.matches('[class*="scroll-fx-reverse-rotate-' + H + '"]') && (F = -F),
                S += "rotate(" + F + "deg)");
                var C = !0;
                t.hasAttribute("data-scroll-lock-distance") && "out" == H && (C = !document.body.classList.contains("scroll-fx-lock")),
                C && (t.classList.contains("scroll-fx-" + H + "-fade") && !t.matches('[class*="scroll-fx-zoom-"], [class*="scroll-fx-rotate-"],[class*="scroll-fx-reverse-rotate-"]') || (t.style.transform = S),
                t.matches('[class*="-' + H + '-fade"]') && (t.style.opacity = T))
            }
        }
        )),
...
function setUpSpecialNavs() {
        ...
        e.addEventListener("click", (function(e) {
            ...
            if (o.parentNode.matches(".fullscreen-nav, .sidebar-nav"))
                ...
                e.target.classList.contains("selected-nav"))
                    ...
                    var n = t.getAttribute("class").replace("navbar", "").replace("row", "").replace("hover-open-submenu", "")
                      , i = o.parentNode.getAttribute("class").replace("navbar-collapse", "").replace("collapse", "").replace("collapsing", "");
                    document.querySelector(".content-tint") || document.body.insertAdjacentHTML("beforeend", '<div class="content-tint"></div>'),
                    document.querySelector(".page-container").insertAdjacentHTML("beforebegin", '<div class="blocsapp-special-menu ' + n + '"><blocsnav class="' + i + '">' + l + "</div>"),
                    ...
                    function() {
                        var e = 0
                          , t = 60
                          , o = "fadeInRight";
                        document.querySelector(".blocsapp-special-menu blocsnav").classList.contains("fullscreen-nav") ? (o = "fadeIn",
                        t = 100) : document.querySelector(".blocsapp-special-menu").classList.contains("nav-invert") && (o = "fadeInLeft");
                        document.querySelectorAll(".blocsapp-special-menu blocsnav li").forEach((l=>{
                            l.parentNode.classList.contains("dropdown-menu") ? l.classList.add.apply(l.classList, ["animated", "fadeIn"]) : (e += t,
                            l.classList.add.apply(l.classList, ["animated", o]),
                            l.setAttribute("style", "animation-delay:" + e + "ms"))
                        }
                        ))
                    }(),
                    document.querySelector("blocsnav").querySelectorAll(".dropdown").forEach(function(dropdown) {
    ...
    delegateSelector("body", "mousedown touchend", ".content-tint, .close-special-menu, .close-special-menu .close-icon", (function(t) {
        e()
    }
    ))
}
function setUpNavExtras() {
    function e(e) {
        ...
        if (t) {
            ...
            if (!t.parentNode.classList.contains("navbar-nav") && !e.closest(".nav-special")) {
                var l = t.offsetWidth - 2
                  , n = e.parentNode.querySelector(".dropdown-menu").offsetWidth;
                o.classList.remove("submenu-left"),
                0 == n && (n = 160),
                t.getBoundingClientRect().left + n + l > window.innerWidth && o.classList.add("submenu-left")
            }
        }
    }
    delegateSelector("body", "click", ".dropdown-menu a.dropdown-toggle", (function(t) {
        e(t.target)
    }
    )),
    document.querySelectorAll(".dropdown-menu a.dropdown-toggle").forEach((function(t) {
...
function scrollToTarget(e, t) {
    ...
    t.matches("[data-scroll-speed]") && (n = parseInt(t.getAttribute("data-scroll-speed")));
    var c = Math.max(.1, Math.min(Math.abs(o - i) / n, .8));
    !function e() {
        var t = (l += 1 / 60) / c
          , n = Math.sin(t * (Math.PI / 2))
          , a = i;
        t < 1 && (requestAnimFrame(e),
        a = o + (i - o) * n),
        window.scrollTo(0, a)
    }()
}
function stickyNavToggle() {
    ...
    if (e) {
        ...
        n && (l = document.querySelector(".fill-bloc-top-edge.sticky-nav").parentNode,
        o = ["sticky", "animated", "fadeIn"]),
        e.classList.contains("sticky") && (t = e.getAttribute("data-original-offset")),
        (window.pageYOffset || document.documentElement.scrollTop) > t ? e.classList.contains("sticky") || (e.classList.add.apply(e.classList, o),
        e.setAttribute("data-original-offset", t),
        t = e.offsetHeight,
        n && (e.style.background = getBlocBgColor(l),
        t += parseInt(window.getComputedStyle(l, null).getPropertyValue("padding-top"))),
        l.style.paddingTop = t + "px") : e.classList.contains("sticky") && (e.classList.remove.apply(e.classList, o),
...
function getBlocBgColor(e) {
    ...
    return e.classList.contains("b-parallax") && (o = window.getComputedStyle(e.querySelector(".parallax"), null).getPropertyValue("background-color")),
    "rgba(0, 0, 0, 0)" == o && -1 == l.indexOf("gradient") && (o = "#FFFFFF"),
    o
}
function hideAll() {
    document.querySelectorAll(".animated").forEach((e=>{
        (!document.body.classList.contains("mob-disable-anim") || document.body.classList.contains("mob-disable-anim") && window.innerWidth > 767) && (e.getBoundingClientRect().top + e.offsetHeight / 3 > window.innerHeight && (e.classList.remove("animated"),
        e.classList.add("hideMe")))
    }
    ))
}
function inViewCheck() {
    [].slice.call(document.querySelectorAll(".hideMe"), 0).reverse().forEach((e=>{
        var t = e.getBoundingClientRect().top + window.scrollY
          , o = t + e.offsetHeight
          , l = window.pageYOffset + window.innerHeight;
        if (e.offsetHeight > window.innerHeight && (o = t),
        o < l) {
            ...
            ["webkitAnimationEnd", "mozAnimationEnd", "oAnimationEnd", "animationEnd"].forEach((function(t) {
                window.addEventListener(t, (function(t) {
                    e.classList.contains("animLoopInfinite") || e.classList.remove(e.getAttribute("data-appear-anim-style"))
                }
                ))
            }
            ))
    ...
    document.querySelectorAll("[data-toggle-visibility]").forEach((function(e) {
        e.addEventListener("click", (function(e) {
            ...
            o.forEach((function(e) {
                !function(e) {
                    if (e) {
                        if (e.classList.contains("toggled-item") || e.classList.add("toggled-item"),
                        "0px" == window.getComputedStyle(e, null).getPropertyValue("height") || e.classList.contains("object-hidden")) {
...
function setUpLightBox() {
    function e() {
        ...
        if (".mp4" == l.substring(l.length - 4)) {
            ...
            o.innerHTML = "<video controls " + n + ' class="embed-responsive-item"><source id="lightbox-video" src="' + l + '" type="video/mp4"></video>'
        } else {
        ...
        1 == s.length && (c.style.display = "none")) : d == s.length - 1 && (c.style.display = "none")
    }
    ...
    document.querySelectorAll("[data-lightbox]").forEach((function(t) {
        t.addEventListener("click", (function(o) {
            ...
            r && r.remove();
            var d = '<svg class="lightbox-close-svg" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 32 32"><path class="lightbox-close-icon" d="M4,4L28,28"/><path class="lightbox-close-icon" d="M28,4L4,28"/></svg>'
            ...
            "fullscreen-lb" == i && (r.classList.add("fullscreen-modal"),
            document.querySelector("#blocs-lightbox-close-btn").remove(),
            r.insertAdjacentHTML("beforeend", '<a class="close-full-screen-modal animated fadeIn" style="animation-delay:0.5s;" data-bs-dismiss="modal">' + d + "</a>")),
            e();
            var g = new bootstrap.Modal(document.querySelector("#lightbox-modal"),{});
            if (g.show(),
            a.length) {
    ...
    window.addEventListener("keydown", (e=>{
        ...
        37 == e.which || 39 == e.which ? (39 == e.which && (t = document.querySelector(".next-lightbox")),
        "none" != t.style.display && t.click()) : 27 == e.which && document.getElementById("blocs-lightbox-close-btn").click()
    }
    ))
}
...
function scrollToPolyFill() {
    ...
    if (!("scrollBehavior"in t.documentElement.style) || !0 === e.__forceSmoothScrollPolyfill__) {
        var o, l = e.HTMLElement || e.Element, n = 468, i = {
            scroll: e.scroll || e.scrollTo,
            scrollBy: e.scrollBy,
            elementScroll: l.prototype.scroll || s,
            scrollIntoView: l.prototype.scrollIntoView
        }, a = e.performance && e.performance.now ? e.performance.now.bind(e.performance) : Date.now, c = (o = e.navigator.userAgent,
        new RegExp(["MSIE ", "Trident/", "Edge/"].join("|")).test(o) ? 1 : 0);
        e.scroll = e.scrollTo = function() {
            void 0 !== arguments[0] && (!0 !== r(arguments[0]) ? m.call(e, t.body, void 0 !== arguments[0].left ? ~~arguments[0].left : e.scrollX || e.pageXOffset, void 0 !== arguments[0].top ? ~~arguments[0].top : e.scrollY || e.pageYOffset) : i.scroll.call(e, void 0 !== arguments[0].left ? arguments[0].left : "object" != typeof arguments[0] ? arguments[0] : e.scrollX || e.pageXOffset, void 0 !== arguments[0].top ? arguments[0].top : void 0 !== arguments[1] ? arguments[1] : e.scrollY || e.pageYOffset))
        }
        ,
        e.scrollBy = function() {
            void 0 !== arguments[0] && (r(arguments[0]) ? i.scrollBy.call(e, void 0 !== arguments[0].left ? arguments[0].left : "object" != typeof arguments[0] ? arguments[0] : 0, void 0 !== arguments[0].top ? arguments[0].top : void 0 !== arguments[1] ? arguments[1] : 0) : m.call(e, t.body, ~~arguments[0].left + (e.scrollX || e.pageXOffset), ~~arguments[0].top + (e.scrollY || e.pageYOffset)))
        }
        ,
        ...
        l.prototype.scrollIntoView = function() {
            if (!0 !== r(arguments[0])) {
                ...
                o !== t.body ? (m.call(this, o, o.scrollLeft + n.left - l.left, o.scrollTop + n.top - l.top),
    ...
    function p(t) {
        var o, l, i, c, s = (a() - t.startTime) / n;
        c = s = s > 1 ? 1 : s,
        o = .5 * (1 - Math.cos(Math.PI * c)),
...
document.addEventListener("DOMContentLoaded", (function() {
    ...
    window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
        var t, o = (this.document || this.ownerDocument).querySelectorAll(e), l = this;
        do {
...
!function(o) {
    ...
    var e;
    o.Dropdown.prototype.toggle = (e = o.Dropdown.prototype.toggle,
    function() {
...
function addDropdownEvent(s) {
    s.addEventListener("hide.bs.dropdown", function(s) {
        this.classList.contains("has-child-dropdown-show") && (this.classList.remove("has-child-dropdown-show"),
        s.preventDefault()),
        s.clickEvent && s.clickEvent.composedPath().some(s=>s.classList && s.classList.contains("dropdown-toggle") && s.parentNode.closest(".dropdown-toggle")) && s.preventDefault(),
        s.stopPropagation()
    })
}
